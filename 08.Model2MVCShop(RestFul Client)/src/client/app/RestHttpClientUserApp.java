...
//		System.out.println("\n====================================\n");
//		// 유저 추가 - Http Post 방식 Request : CodeHaus lib 사용		
//		RestHttpClientUserApp.addUserTest();

//		System.out.println("\n====================================\n");
//		// 유저 리스트 가져오기 - Http Get 방식 Request : CodeHaus lib 사용
//		RestHttpClientUserApp.getUserListTest();

//		System.out.println("\n====================================\n");
//		// 유저 수정 - Http Post 방식 Request : CodeHaus lib 사용		
		RestHttpClientUserApp.updateUserTest();
	}
...
//================================================================//
	...
	public static void getUserTest_JsonSimple() throws Exception {
		...
		System.out.println("JsonOnject : " + jsonobj);
	}
...
//================================================================//
	public static void addUserTest() throws Exception {
		...
		// [ 방법 3 : codehaus 사용]
		User user = new User();
		user.setUserId("addUserTest");
		user.setUserName("test");
		user.setPassword("123456789");
		user.setSsn("1905062222222");
		user.setPhone("010-1111-2222");
		user.setAddr("비트 강남");
		user.setEmail("dddiieks@naver.com");
	...
	public static void getUserListTest() throws Exception {
		// HttpClient : Http Protocol 의 client 추상화
		HttpClient httpClient = new DefaultHttpClient();
		...
		List<User> list = objectMapper.readValue(jsonobj.get("list").toString(), new TypeReference<List<User>>() {
		});
		for (int i = 0; i < list.size(); i++) {
			System.out.println("User[" + i + "] : " + list.get(i));
		}
	...
	public static void updateUserTest() throws Exception {
		...
		user.setPhone("999-8888-7777");
		user.setAddr("2층 비트 강남");
